...
class ImageVisionTransformerEncoderSupForVideo(nn.Module):
    """ Vision Transformer
    ...
    def __init__(self, cfg):
        ...
        use_learnable_pos_emb = cfg.VIDEO.BACKBONE.POS_EMBD_LEARNABLE
...
class ImageVisionTransformerDecoderSupForVideo(nn.Module):
    ...
    def __init__(self, cfg
        ...
        in_chans = 3
        num_classes = 1536
        embed_dim = cfg.VIDEO.HEAD.DECODER.NUM_FEATURES if cfg.VIDEO.BACKBONE.DEPTH == 24 else 384
        depth = cfg.VIDEO.HEAD.DECODER.DEPTH if cfg.VIDEO.BACKBONE.DEPTH == 24 else 4
        num_heads = cfg.VIDEO.HEAD.DECODER.NUM_HEADS if cfg.VIDEO.BACKBONE.DEPTH == 24 else 6
        mlp_ratio = 4
        qkv_bias = True
        qk_scale = None
        drop_rate = 0
