...
sys.path.append(os.path.abspath(os.curdir)+"/Masked-Action-Recognition")
sys.path.append("/root/code/Masked-Action-Recognition")
    ...
    if cfg.TEST.ENABLE:
        ...
        if cfg.TEST.AUTOMATIC_MULTI_SCALE_TEST:
            ...
            if "kinetics" in cfg.TEST.DATASET or "epickitchen" in cfg.TEST.DATASET:
                cfg.TEST.NUM_SPATIAL_CROPS = 3
                if "MultiScaleVisionTransformer" in cfg.VIDEO.BACKBONE.META_ARCH:
                    cfg.TEST.NUM_ENSEMBLE_VIEWS = 10
                    cfg.TEST.NUM_SPATIAL_CROPS = 1
                elif "ConvNeXt" in cfg.VIDEO.BACKBONE.META_ARCH:
                    cfg.TEST.NUM_ENSEMBLE_VIEWS = 4
                    cfg.TEST.NUM_SPATIAL_CROPS = 3
                elif "JointTransformer" in cfg.VIDEO.BACKBONE.META_ARCH:
                    cfg.TEST.NUM_ENSEMBLE_VIEWS = 7
                elif "Transformer" in cfg.VIDEO.BACKBONE.META_ARCH:
                    cfg.TEST.NUM_ENSEMBLE_VIEWS = 10
